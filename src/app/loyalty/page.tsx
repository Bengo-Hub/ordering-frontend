      ...
      <section className="border-b border-border bg-brand-muted/50 py-16">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground">
            {brand.shortName} keeps loyalty logic centralized, offering configurable thresholds,
            cross-sell nudges, and treasury-backed redemption flows ready for SaaS distribution.
          </p>
        </div>
      </section>
